...
/**
 * 봉(옛 월아산) 자동 연발의 눈 — <b>좌클릭 한 번 = 공격 한 번, 홀드는 병기의 박자를 넘지 못한다.</b>
 *
 * <p>실사용 발견 (2026-07-17): "월아산(현 봉)으로 좌클릭 시 자동으로 계속 공격이 나간다."
 ...
 * 갓 뚫린 구멍을 지나 빗나가고, 봉(유일한 삽 베이스 병기)은 땅을 2~4틱에 깨서 그 합성이 초당 여러 번
...
public final class AttackRhythmSelfTest {
    ...
    public static void main(String[] args) {
        ...
        // ══════════ ② 실측 폭풍의 재연 — 봉(삽 베이스)으로 땅을 향해 홀드 (흙 = 2~4틱 + 지연 5틱) ══════════
        ...
        //   봉 공속 1.0/s → 스윙 간격 20틱 (Weapons.Series 봉 speedMod -3.0 · 20/1.0).
        //   등록부 연출 간격은 4틱 (config/skill_motion.yml basic_strike.cooldown_ticks).
        eye("봉(간격 20틱) — 박자가 등록부 간격(4틱)을 이긴다: 다음 획은 +20틱",
        ...
        eye("홀드 1초의 연발 상한 — 봉(간격 20틱)은 한 획을 넘지 못한다",
