...
★헌법과의 관계 (조율자 독법 — 사용자 확인 대기): §2.4 "땅에 맞게 건물이 올라가는 것이지,
건축에 맞게 지형이 생기는 게 아니다"는 **집행 순서의 계약**(건축이 선 땅을 못 바꾼다 · 땅은
한 번만)이고, 이 요건은 **설계 시점의 계약**(땅을 빚기 전에 건축의 치수를 안다)이다 — 둘은
양립한다고 읽었다. 만약 사용자의 뜻이 §2.4 자체의 개정이라면 그 조문을 고쳐야 한다.
