...
- `열림` **E-02 · 중앙축이 막혔다** — 정자 두 채가 `cx±7` 에 서서 산문→종문 축을 나눠 먹는다.
  목표 7호는 중앙이 비고 계단이 축을 곧게 오르며 **건물·나무는 양옆**이다.
  사용자 확정과도 같은 말: 「외원은 빈 문전을 채우는 공간이 아니라 그 비어 있는 중앙축의
  **양옆**을 구성하는 공간이다」. **사용자 결정 대기**
