...
- **닫힘**: —  ※설계 완료 (2026-07-14, R4 병³): `docs/design/personal_story.md` + `config/personal_story.yml` (발단 11종 전량 + default — 어휘 대조 11/11 일치). 닫힘은 구현 최소선(Rules 로더→평가기→logEvent 훅→심중 한 줄)이 서고 신규 캐릭터 실기동에서 첫 목표가 보일 때
