...
```
- **승인·동결** (사용자 2026-08-07): E-01 공공 포장 · E-02 의례축 11 ·
  E-03 삼면 행각 · E-08 다중 인스턴스 도면.
- **다음**: E-07 정자 문법 — 「외원 안에서 행각은 새 언어인데 남측 정자는 아직 옛 언어다.
  종문·중정으로 넘어가기 전에 외원의 두 건축 언어를 하나로 맞춘다」 (사용자)
