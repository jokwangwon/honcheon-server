...
전체 디자인은 마스터플랜(20구역·3색 조닝)이 정본. 기존 문법이 해치면 수정.」 판정: 산세 골격
...
캠퍼스 앉힘·계단 자재기·고의 위반 6종 거절·팔레트). ★남은 것: 시험 서버 실기동 첫 판독
(플러그인 재기동 필요 — jar 짝 계율) · 구역 16·10·11 + 건물 배치기 (슬라이스 2) · 곁봉
패드·운무교 18·19·20 (슬라이스 3) · 조경 (슬라이스 4) · 산기슭 도보길↔산문 접속.
