...
④ id 우회·access 로더 누락 자기시험. ★임시 안전(사용자 결정 대기 — 회신 §11-8): 구현 전까지
비op id 직행을 막거나 access:항상/공개 장소만 허용 (G-1 재결정 필요 — 전제가 무너졌다).
...
계약이다 — 화산 시험 조성(배선)의 관문. 헌장 §2.3 문안은 사용자 승인 대기 (회신 §11-1).
