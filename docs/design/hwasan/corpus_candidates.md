...
## ★★방향 확정 — 조선풍 한옥 퓨전 (사용자 2026-08-28)

> **「중국 도관 계열은 버린다. 틀과 설정만 유지한 채 조선풍 한옥 느낌의
> 퓨전 무림 형태로 제작한다.」**

- **틀은 유지**: 20구역 마스터플랜 · 공간 계약(contract.md) · 산세·배치 · 세계관 설정
- **시각은 전환**: 조선풍 한옥 퓨전 — 한옥마을 코퍼스가 곧 **주 학습원**이다
- 파장: ① 중국 도관 후보(옛 C-02~04)는 제외로 ② D2 수렴의 기준이던
  `ref/09_honjeon.png` 5지표(중국풍 렌더)는 **지위 재정의 대상** — 다음 회차 안건
  ③ `ref/` 13장은 형태·구도 참고로 강등될지 사용자와 정한다

## 고르는 기준 넷 (SYSTEM_REVIEW ⑥ · 2026-08-28 개정)

1. **같은 척도** — 중형 전각 (폭 20~50칸). 초대형 재현물은 2군(지붕·공포 참고)으로만
2. **바닐라 팔레트** — Conquest·cocricot 등 모드 팔레트는 제외
3. **양식** — ★**조선풍 한옥 1순위** (방향 확정 · 위) · 중국 도관은 **제외** ·
